...
class PlayState extends MusicBeatState
{
	...
	public var stageDebugX = 0; // STAGE DEBUG BULLSHIT
	public var stageDebugY = 0;
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'beach': // Week 42069 (ame's week)
				...
				if(!ClientPrefs.lowQuality) {
					var letrollishouse:BGSprite = new BGSprite('ame/house', 640, -162, 0.9, 0.9);
					letrollishouse.updateHitbox();
					add(letrollishouse);
				}
		}
